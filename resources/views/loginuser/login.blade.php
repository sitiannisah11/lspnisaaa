...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <!-- font Awesome -->
        <link href="/login-template/Universitas Trilogi_files/font-awesome.min.css" rel="stylesheet" type="text/css">
        <!-- Theme style -->
  ...
  <!-- Custom fonts for this template-->
    ...
    <body class="login-page" style="">
        ...
        <!-- jQuery 2.0.2 -->
        <script type="text/javascript" async="" src="/login-template/Universitas Trilogi_files/analytics.js.download"></script><script src="./Universitas Trilogi_files/jquery.min.js.download"></script>
        <!-- Bootstrap -->
        <script src="/login-template/Universitas Trilogi_files/bootstrap.min.js.download" type="text/javascript"></script>        
            <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async="" src="/login-template/Universitas Trilogi_files/js"></script>
    <script>
