    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/stokppn/update" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Stok Minimum</label>
            <input type="text" class="form-control" name="stok" id="recipient-name" value="{{$j->stok}}" required="">
          </div>
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">PPN</label>
            <input type="text" class="form-control" name="ppn" id="recipient-name" value="{{$j->ppn}}" required="">
          </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/stokppn/delete/{{$j->id}}" class="btn btn-orange btn-sm waves-effect waves-light">
