  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/laba/add" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Laba</label>
...
@foreach($laba as $j)
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/laba/update" method="POST" enctype="multipart/form-data">
          @csrf
...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header-index" style="display: flex; justify-content: space-between; align-items: center;">
      <h6 class="m-0 font-weight-bold"><strong>Data Laba</strong></h6>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/laba/delete/{{$j->id}}" class="btn btn-orange btn-sm waves-effect waves-light">
